...
<body ng-app="crudAdminContactApp" ng-controller="crudAdminContactController" ng-init="user_profile='<?php echo $user['email']; ?>'">
    <?php
    ...
    <div class="contact-us-container" ng-init="checkcolor()">
        ...
        <div class="contact-us-section contact-us-section2">
            ...
            <p><a href="tel:1111111111">+30 1111111111</a><br>
                <a href="tel:2222222222">+30 2222222222</a>
            </p>
            <h3>Address</h3>
...
<script src="../controllers/adminContactApp.js"></script>